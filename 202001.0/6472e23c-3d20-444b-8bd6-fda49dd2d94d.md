To install the Demo Shop for B2C implementations on Mac OS or Linux with Development Virtual Machine, follow the steps below.
...
* [http://www.de.b2c-demo-shop.local/](http://www.de.b2c-demo-shop.local/){target="_blank"} - front-end (Storefront);
